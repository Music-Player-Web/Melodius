                ...
                playlists.map((playlist) => (
                  <MUI.Grid item xs={12} sm={6} md={4} key={playlist.pk}>
                    <Card>
                      ...
                      <CardActions>
                        <MUI.Button
                          onClick={() => this.handleOpenEditDialog(playlist)}
                          style={{ color: "red" }}
                        >
                          Edit Playlist
                        </MUI.Button>
                        &nbsp;&nbsp;
                        <MUI.Button
                          onClick={() => this.handleOpenDeleteDialog(playlist)}
                          style={{ color: "red" }}
                        >
                          Delete Playlist
                        </MUI.Button>
          ...
          >
            ...
            <MUI.DialogContent>
              <EditPlayListForm
                ...
                playlist={this.state.selectedPlaylist} // Pass selectedPlaylist as prop
              />
            </MUI.DialogContent>
            <MUI.DialogActions>
